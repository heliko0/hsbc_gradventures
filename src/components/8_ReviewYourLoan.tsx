  ...
  return (
    <div className={styles.successIconWrapper}>
      <div className={styles.successIcon}>
        <svg className={styles.successIconSvg} fill="none" preserveAspectRatio="none" viewBox="0 0 18 18">
          <g>
            <g></g>
    ...
    <div className={styles.lowerInterestBanner}>
      <div className={styles.lowerInterestContent}>
        ...
        <div className={styles.lowerInterestTextWrapper}>
          <p className={styles.lowerInterestText}>Your interest is 0.4% lower thanks to your hybrid Stability Score!</p>
        </div>
      </div>
    </div>
  );
...
export default function ReviewYourLoan({ onSubmit, initialLoanAmount = 10000, initialMonths = 62 }: ReviewYourLoanProps) {
