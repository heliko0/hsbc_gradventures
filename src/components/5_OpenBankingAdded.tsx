    ...
    return (
        <div className={styles.header}>
            ...
            <p className={styles.headerSubtitle}>
                Bank (or banked) with anyone else? You can link those accounts
                here.
            </p>
        </div>
    );
...
function WhatIsOpenBanking() {
    return (
        <div className={styles.whatIsOpenBanking}>
            <p className={styles.whatIsOpenBankingTitle}>
                What is Open Banking?
            </p>
            <p className={styles.whatIsOpenBankingDescription}>
                We use Open Banking (read‑only) to identify regular payments
    ...
    return (
        <div className={styles.linkAccountsHeader}>
            ...
            <p className={styles.linkAccountsDescription}>
                If you only bank with HSBC, you're all set. You can add other
                banks you use to give a fuller picture, and remove access at any
                time.
            </p>
        </div>
    );
        ...
        <div className={styles.secondaryButton}>
            ...
            <div className={styles.secondaryButtonInner}>
                <div className={styles.secondaryButtonContent}>
                    <p className={styles.secondaryButtonText}>
                        Change selection
                    </p>
                </div>
            </div>
