import svgPaths from "./svg-xdyvg42q3i";
...
function Text() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[normal] not-italic relative shrink-0 w-full" data-name="Text">
      ...
      <p className="font-['Inter:Light',sans-serif] font-light relative shrink-0 text-[12px] text-black w-full">Click here to view and accept your loan agreement.</p>
    </div>
  );
}
...
function ElementsContainer() {
  return (
    <div className="content-stretch flex gap-[8px] items-start justify-center relative shrink-0" data-name="Elements container">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] not-italic relative shrink-0 text-[16px] text-center text-nowrap text-white whitespace-pre">View your loan agreement</p>
    </div>
  );
}
...
function OnLightButtonPrimary() {
  return (
    <div className="bg-[#db0011] box-border content-stretch flex items-start justify-center pb-[11px] pt-[9px] px-[20px] relative shrink-0 w-[343px]" data-name="On Light: Button primary">
      <ElementsContainer />
    </div>
  );
}
...
function MessageContainer() {
  return (
    <div className="basis-0 content-stretch flex gap-[10px] grow items-start min-h-px min-w-px overflow-clip relative shrink-0" data-name="Message container">
      <p className="basis-0 font-['Inter:Light',sans-serif] font-light grow leading-[normal] min-h-px min-w-px not-italic relative shrink-0 text-[#333333] text-[12px]">Please view and accept the agreement before continuing</p>
    </div>
  );
}
...
function NotificationContextual() {
  return (
    <div className="bg-[#fff8ea] relative shrink-0 w-full" data-name="Notification contextual">
      <div aria-hidden="true" className="absolute border border-[#ffb006] border-solid inset-0 pointer-events-none" />
      <div className="size-full">
...
function OnLightButtonPrimary1() {
  return (
    <div className="bg-[#d7d8d6] relative shrink-0 w-full" data-name="On Light: Button primary">
