import svgPaths from "./svg-bos869ogsu";
...
function Header() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start leading-[normal] not-italic relative shrink-0 text-[#333333] w-full" data-name="Header">
      ...
      <p className="font-['Inter:Light',sans-serif] font-light min-w-full relative shrink-0 text-[16px] w-[min-content]">A helpful look at how your money habits support this application.</p>
    </div>
  );
}
...
function Score() {
  return (
    <div className="h-[100px] leading-[normal] not-italic relative shrink-0 text-[#333333] w-[86px]" data-name="Score">
      <p className="absolute font-['Inter:Regular',sans-serif] font-normal left-[43px] text-[19px] text-center top-0 translate-x-[-50%] w-[86px]">Score</p>
      <p className="absolute font-['Inter:Bold',sans-serif] font-bold left-0 text-[64px] top-[23px] w-[86px]">84</p>
    </div>
  );
}
