import svgPaths from "./svg-l7xr3kb7hk";
  ...
  return (
    <div className="relative shrink-0 size-[24px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <g id="Container"></g>
          <path d={svgPaths.pbc7aa00} fill="var(--fill-0, #333333)" id="Icon_2" />
        </g>
      </svg>
    </div>
  );
...
function Icon3() {
  return (
    <div className="content-stretch flex gap-[10px] items-center justify-center overflow-clip relative shrink-0" data-name="Icon">
      <Icon2 />
    </div>
  );
}
...
function Text1() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col gap-[4px] grow items-start min-h-px min-w-px not-italic overflow-clip pb-0 pt-[2px] px-0 relative shrink-0 text-[#333333] text-[12px]" data-name="Text">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-nowrap whitespace-pre">Savings</p>
      <div className="flex flex-col font-['Inter:Light',sans-serif] font-light justify-center leading-[0] min-w-full relative shrink-0 w-[min-content]">
        <p className="leading-[normal]">How much you have set aside</p>
      </div>
    </div>
  );
}
...
function Text2() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col gap-[4px] grow items-start min-h-px min-w-px not-italic overflow-clip pb-0 pt-[2px] px-0 relative shrink-0 text-[#333333] text-[12px]" data-name="Text">
      ...
      <div className="flex flex-col font-['Inter:Light',sans-serif] font-light justify-center leading-[0] min-w-full relative shrink-0 w-[min-content]">
        <p className="leading-[normal]">Regular monthly housing payments</p>
      </div>
    </div>
  );
}
...
function Text3() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col gap-[4px] grow items-start min-h-px min-w-px not-italic overflow-clip pb-0 pt-[2px] px-0 relative shrink-0 text-[#333333] text-[12px]" data-name="Text">
      ...
      <div className="flex flex-col font-['Inter:Light',sans-serif] font-light justify-center leading-[0] min-w-full relative shrink-0 w-[min-content]">
        <p className="leading-[normal]">On‑time essential bill payments</p>
      </div>
    </div>
  );
}
...
function Icon8() {
  return (
    <div className="h-[24px] relative shrink-0 w-[24.001px]" data-name="Icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 24 24">
        <g id="Icon">
          <g id="Container"></g>
          <path clipRule="evenodd" d={svgPaths.paa85e00} fill="var(--fill-0, #333333)" fillRule="evenodd" id="Icon_2" />
        </g>
      </svg>
    </div>
  );
...
function Text4() {
  return (
    <div className="basis-0 box-border content-stretch flex flex-col gap-[4px] grow items-start min-h-px min-w-px not-italic overflow-clip pb-0 pt-[2px] px-0 relative shrink-0 text-[#333333] text-[12px]" data-name="Text">
      <p className="font-['Inter:Medium',sans-serif] font-medium leading-[normal] relative shrink-0 text-nowrap whitespace-pre">Car Payments</p>
      <div className="flex flex-col font-['Inter:Light',sans-serif] font-light justify-center leading-[0] min-w-full relative shrink-0 w-[min-content]">
        <p className="leading-[normal]">Fixed instalments paid regularly</p>
      </div>
    </div>
  );
}
...
function DataSourcesCards() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-[348px]" data-name="Data sources cards">
      ...
      <UtilityAndPhoneBIll />
      <Rent />
      <UtilityAndPhoneBIll1 />
      <UtilityAndPhoneBIll2 />
    </div>
  );
}
